...
// PlanesController operations for Planes
type PlanesController struct {
	beego.Controller
}

// URLMapping ...
func (c *PlanesController) URLMapping() {
...
// @Param	body		body 	models.Planes	true		"body for Planes content"
// @Success 201 {int} models.Planes
// @Failure 403 body is empty
// @router / [post]
func (c *PlanesController) Post() {
	var v models.Planes
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddPlanes(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get Planes by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Planes
// @Failure 403 :id is empty
// @router /:id [get]
func (c *PlanesController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetPlanesById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 403
// @router / [get]
func (c *PlanesController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllPlanes(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the Planes
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Planes	true		"body for Planes content"
// @Success 200 {object} models.Planes
// @Failure 403 :id is not int
// @router /:id [put]
func (c *PlanesController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Planes{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdatePlanesById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the Planes
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *PlanesController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeletePlanes(id); err == nil {
