...
// PlanFeaturesController operations for PlanFeatures
type PlanFeaturesController struct {
	beego.Controller
}

// URLMapping ...
func (c *PlanFeaturesController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create PlanFeatures
// @Param	body		body 	models.PlanFeatures	true		"body for PlanFeatures content"
// @Success 201 {int} models.PlanFeatures
// @Failure 403 body is empty
// @router / [post]
func (c *PlanFeaturesController) Post() {
	var v models.PlanFeatures
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddPlanFeatures(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get PlanFeatures by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.PlanFeatures
// @Failure 403 :id is empty
// @router /:id [get]
func (c *PlanFeaturesController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetPlanFeaturesById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 403
// @router / [get]
func (c *PlanFeaturesController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllPlanFeatures(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the PlanFeatures
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.PlanFeatures	true		"body for PlanFeatures content"
// @Success 200 {object} models.PlanFeatures
// @Failure 403 :id is not int
// @router /:id [put]
func (c *PlanFeaturesController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.PlanFeatures{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdatePlanFeaturesById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the PlanFeatures
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *PlanFeaturesController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeletePlanFeatures(id); err == nil {
