...
type Ofertas struct {
	Id                 int             `orm:"column(id_ofertas);pk;auto"`
	IdEmpleador        int             `orm:"column(id_empleador)"`
	...
	IdModalidadTrabajo int             `orm:"column(id_modalidad_trabajo)"`
	InsumosCliente     bool            `orm:"column(insumos_cliente)"`
	Vigilancia         bool            `orm:"column(vigilancia)"`
	IdTipoMascota      int             `orm:"column(id_tipo_mascota)"`
...
func GetOfertasById(id int) (v *Ofertas, err error) {
	...
	if err = o.Read(v); err == nil {
		o.LoadRelated(v, "IdEmpleador")
		o.LoadRelated(v, "IdDiasTrabajados")
		o.LoadRelated(v, "IdTipoInmueble")
		o.LoadRelated(v, "IdTamanoInmueble")
		o.LoadRelated(v, "IdModalidadTrabajo")
		o.LoadRelated(v, "IdTipoMascota")
...
func GetAllOfertas(query map[string]string, fields []string, sortby []string, order []string,
	...
	o := orm.NewOrm()
	qs := o.QueryTable(new(Ofertas)).RelatedSel()
	// query k=v
	for k, v := range query {
