...
// CertificacionesController operations for Certificaciones
type CertificacionesController struct {
	beego.Controller
}

// URLMapping ...
func (c *CertificacionesController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Certificaciones
// @Param	body		body 	models.Certificaciones	true		"body for Certificaciones content"
// @Success 201 {int} models.Certificaciones
// @Failure 403 body is empty
// @router / [post]
func (c *CertificacionesController) Post() {
	var v models.Certificaciones
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddCertificaciones(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get Certificaciones by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Certificaciones
// @Failure 403 :id is empty
// @router /:id [get]
func (c *CertificacionesController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetCertificacionesById(id)
	if err != nil {
		logs.Error(err)
...
// GetAll ...
// @Title Get All
// @Description get Certificaciones
...
// @Failure 403
// @router / [get]
func (c *CertificacionesController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllCertificaciones(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the Certificaciones
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Certificaciones	true		"body for Certificaciones content"
// @Success 200 {object} models.Certificaciones
// @Failure 403 :id is not int
// @router /:id [put]
func (c *CertificacionesController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Certificaciones{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateCertificacionesById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the Certificaciones
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *CertificacionesController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteCertificaciones(id); err == nil {
