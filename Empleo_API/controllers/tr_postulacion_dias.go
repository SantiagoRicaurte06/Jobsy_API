...
// TrPostulacionDiasController operations for TrPostulacionDias
type TrPostulacionDiasController struct {
	beego.Controller
}

// URLMapping ...
func (c *TrPostulacionDiasController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create TrPostulacionDias
// @Param	body		body 	models.TrPostulacionDias	true		"body for TrPostulacionDias content"
// @Success 201 {int} models.TrPostulacionDias
// @Failure 403 body is empty
// @router / [post]
func (c *TrPostulacionDiasController) Post() {
	var v models.TrPostulacionDias
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTrPostulacionDias(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get TrPostulacionDias by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.TrPostulacionDias
// @Failure 403 :id is empty
// @router /:id [get]
func (c *TrPostulacionDiasController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTrPostulacionDiasById(id)
	if err != nil {
		logs.Error(err)
...
// GetAll ...
// @Title Get All
// @Description get TrPostulacionDias
...
// @Failure 403
// @router / [get]
func (c *TrPostulacionDiasController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllTrPostulacionDias(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the TrPostulacionDias
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.TrPostulacionDias	true		"body for TrPostulacionDias content"
// @Success 200 {object} models.TrPostulacionDias
// @Failure 403 :id is not int
// @router /:id [put]
func (c *TrPostulacionDiasController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TrPostulacionDias{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTrPostulacionDiasById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the TrPostulacionDias
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *TrPostulacionDiasController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTrPostulacionDias(id); err == nil {
