...
// TipoInmuebleController operations for TipoInmueble
type TipoInmuebleController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoInmuebleController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create TipoInmueble
// @Param	body		body 	models.TipoInmueble	true		"body for TipoInmueble content"
// @Success 201 {int} models.TipoInmueble
// @Failure 403 body is empty
// @router / [post]
func (c *TipoInmuebleController) Post() {
	var v models.TipoInmueble
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoInmueble(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get TipoInmueble by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.TipoInmueble
// @Failure 403 :id is empty
// @router /:id [get]
func (c *TipoInmuebleController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoInmuebleById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 403
// @router / [get]
func (c *TipoInmuebleController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllTipoInmueble(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the TipoInmueble
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.TipoInmueble	true		"body for TipoInmueble content"
// @Success 200 {object} models.TipoInmueble
// @Failure 403 :id is not int
// @router /:id [put]
func (c *TipoInmuebleController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoInmueble{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTipoInmuebleById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the TipoInmueble
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *TipoInmuebleController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoInmueble(id); err == nil {
