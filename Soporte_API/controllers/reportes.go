...
// @Success 201 {int} models.Reportes
// @Failure 403 body is empty
// @router / [post]
func (c *ReportesController) Post() {
	var v models.Reportes
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddReportes(&v); err == nil {
...
func (c *ReportesController) GetOne() {
	...
	v, err := models.GetReportesById(id)
	if err != nil {
		logs.Error(err)
...
func (c *ReportesController) GetAll() {
	...
	l, err := models.GetAllReportes(query, fields, sortby, order, offset, limit)
	if err != nil {
...
func (c *ReportesController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Reportes{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateReportesById(&v); err == nil {
...
func (c *ReportesController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteReportes(id); err == nil {
