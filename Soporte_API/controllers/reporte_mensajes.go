...
// ReporteMensajesController operations for ReporteMensajes
type ReporteMensajesController struct {
	beego.Controller
}

// URLMapping ...
func (c *ReporteMensajesController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create ReporteMensajes
// @Param	body		body 	models.ReporteMensajes	true		"body for ReporteMensajes content"
// @Success 201 {int} models.ReporteMensajes
// @Failure 403 body is empty
// @router / [post]
func (c *ReporteMensajesController) Post() {
	var v models.ReporteMensajes
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddReporteMensajes(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get ReporteMensajes by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.ReporteMensajes
// @Failure 403 :id is empty
// @router /:id [get]
func (c *ReporteMensajesController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetReporteMensajesById(id)
	if err != nil {
		logs.Error(err)
...
// GetAll ...
// @Title Get All
// @Description get ReporteMensajes
...
// @Failure 403
// @router / [get]
func (c *ReporteMensajesController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllReporteMensajes(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the ReporteMensajes
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.ReporteMensajes	true		"body for ReporteMensajes content"
// @Success 200 {object} models.ReporteMensajes
// @Failure 403 :id is not int
// @router /:id [put]
func (c *ReporteMensajesController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.ReporteMensajes{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateReporteMensajesById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the ReporteMensajes
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *ReporteMensajesController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteReporteMensajes(id); err == nil {
