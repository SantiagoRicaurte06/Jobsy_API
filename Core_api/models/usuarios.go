...
type Usuarios struct {
	...
	IdGenero        int            `orm:"column(id_genero)"`
	Nacionalidad    string         `orm:"column(nacionalidad)"`
	FotoUrl         string         `orm:"column(foto_url)"`
	IdRolesUsuarios *RolesUsuarios `orm:"column(id_roles_usuarios);rel(fk)"`
...
func GetUsuariosById(id int) (v *Usuarios, err error) {
	...
	if err = o.Read(v); err == nil {
		o.LoadRelated(v, "IdGenero")
		o.LoadRelated(v, "IdRolesUsuarios")
		return v, nil
	}
	return nil, err
}
