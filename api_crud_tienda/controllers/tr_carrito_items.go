...
// @Parambodybody models.TrCarritoItemstrue"body for TrCarritoItems content"
...
// @Paramidpath stringtrue"The key for staticblock"
...
// @Paramqueryquerystringfalse"Filter. e.g. col1:v1,col2:v2 ..."
// @Paramfieldsquerystringfalse"Fields returned. e.g. col1,col2 ..."
// @Paramsortbyquerystringfalse"Sorted-by fields. e.g. col1,col2 ..."
// @Paramorderquerystringfalse"Order corresponding to each sortby field, if single value, apply to all sortby fields. e.g. desc,asc ..."
// @Paramlimitquerystringfalse"Limit the size of result set. Must be an integer"
// @Paramoffsetquerystringfalse"Start position of result set. Must be an integer"
// @Success 200 {object} models.TrCarritoItems
...
// @Paramidpath stringtrue"The id you want to update"
// @Parambodybody models.TrCarritoItemstrue"body for TrCarritoItems content"
// @Success 200 {object} models.TrCarritoItems
...
// @Paramidpath stringtrue"The id you want to delete"
